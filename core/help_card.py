...
PUBLIC_HELP_SECTIONS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "commands": (
            {
                "syntax": "token new private [名称] [--provider <omp|opencode>]",
                "description": "创建私聊 Endpoint；默认 omp，opencode 需对应 adapter",
            },
            {
                "syntax": "token new group <数字群号> [名称] [--provider <omp|opencode>]",
                "description": "aiocqhttp：私聊申请并预绑定数字群号",
            },
            {
                "syntax": "token new group current [名称] [--provider <omp|opencode>]",
